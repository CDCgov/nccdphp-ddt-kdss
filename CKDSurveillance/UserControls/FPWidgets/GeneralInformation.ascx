...
<div class="row general-information">
        ...
        <div class="col-md-9">
            ...
            <div class="row generalinformation-text">When people develop <span style="font-weight:bold;margin-left:calc(-1 * var(--bs-gutter-x) * .5) !important;margin-right:calc(-1 * var(--bs-gutter-x) * .5) !important">chronic kidney disease (CKD)</span>, their kidneys become damaged and over time may not clean the blood as well as healthy kidneys. If kidneys do not work well, toxic waste and extra fluid accumulate in the body and may lead to high blood pressure, heart disease, stroke, and early death. However, people with CKD and people at risk for CKD can take steps to protect their kidneys with the help of their health care providers.</div>
           <%-- <div class="row">
