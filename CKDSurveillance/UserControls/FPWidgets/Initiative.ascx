<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Initiative.ascx.cs" Inherits="CKDSurveillance_RD.UserControls.FPWidgets.Initiative" %>
...
<div class="row">
    <div class="col-12">
        <div class="card card-multi ds-5 border-0 mb-3 bg-white">
            <div class="card-multi bt-4 bt-blue-p mb-3 h6" style="padding-left: 10px;">CKD Initiative</div>
