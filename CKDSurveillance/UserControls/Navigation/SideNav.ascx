...
<div class="container d-flex flex-wrap body-wrapper bg-white">
    ...
    <nav role="navigation" aria-label="Left Navigation Menu" style="border-bottom-color: white">
        <div id="cdc-left-nav-menu">
            <div>
                <%--<img src="../../images/CKDLeftNavLogo.png" class="logoImg" />--%>
            ...
            <div>
                <%-- class="card-header nav-section-home navSectionLinks navlist"--%>
                <div id="divAYA" runat="server" class="navBoldHeader nav-section-home d-sm-block" style="background: white !important;" role="tabpanel">
                    <%-- class="card-header nav-section-home navSectionLinks navlist"--%>
                    <%-- 508 Fix: Changed from plain text to proper heading element --%>
                    <h2 class="navBoldHeader-heading">Are You Aware Topics</h2>
                </div>
                <div id="divAYARF" runat="server">
                    ...
                    <div class="accordion indicator-plus accordion-white" role="tabpanel">
                        <div style="padding-left: 0px; background-color: none !important;">
                            <%-- class="card bar "--%>
                                ...
                                <div>
                                    ...
                                    <div class="row" style="padding-bottom: 2px">
                                        <div class="col-12" style="padding-left: 20px;">
                                            <div id="link_August_2023" data-parentid="20">
                                                <%--class="row articlelinkdiv"--%>
                                                <ul>
                    ...
                    <div id="div1" runat="server">
                        <%--style="padding-left:1px;padding-right:1px;"--%>
                        <div class="accordion indicator-plus accordion-white" role="tabpanel">
                            <div style="padding-left: 0px; background-color: none !important;" role="tablist">
                                <%-- class="card bar "--%>
                                ...
                                <div aria-labelledby="accordion-4i-card-18" class="collapse" id="accordion-4i-collapse-18" role="tabpanel">
                                    <div>
                                        ...
                                        <div class="row" style="padding-bottom: 2px">
                                            <div class="col-12" style="padding-left: 20px;">
                                                <div id="link_April_2023" data-parentid="18">
                                                    <%--class="row articlelinkdiv"--%>
                                                    <ul>
                                                        <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
                            ...
                            <div aria-labelledby="accordion-4i-card-17" class="collapse" id="accordion-4i-collapse-17" role="tabpanel">
                                <div>
                                    ...
                                    <div class="row" style="padding-bottom: 2px">
                                        ...
                                        <div class="col-12" style="padding-left: 20px;">
                                            <div id="link_December_2023" data-parentid="17">
                                                <%--class="row articlelinkdiv"--%>
                                                <ul>
                                                    <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
                                        ...
                                        <div class="col-12" style="padding-left: 20px;">
                                            <div id="link_October_2022" data-parentid="17">
                                                <%--class="row articlelinkdiv"--%>
                                                <ul>
                                                    <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
                            ...
                            <div style="padding-left: 0px; background-color: none !important;" role="tablist">
                                ...
                                <div aria-labelledby="accordion-4i-card-21" class="collapse" id="accordion-4i-collapse-21" role="tabpanel">
                                    <div>
                                        ...
                                        <div class="row" style="padding-bottom: 2px">
                                            <div class="col-12" style="padding-left: 20px;">
                                                <div id="link_February_2024" data-parentid="21">
                                                    <%--class="row articlelinkdiv"--%>
                                                    <ul>
                                                        <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
                            ...
                            <div aria-labelledby="accordion-4i-card-19" class="collapse" id="accordion-4i-collapse-19" role="tabpanel">
                                <div>
                                    ...
                                    <div class="row" style="padding-bottom: 2px">
                                        ...
                                        <div class="col-12" style="padding-left: 20px;">
                                            <div id="link_October_2023" data-parentid="19">
                                                <%--class="row articlelinkdiv"--%>
                                                <ul>
                                                    <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
                                        ...
                                        <div class="col-12" style="padding-left: 20px;">
                                            <div id="link_June_2023" data-parentid="19">
                                                <%--class="row articlelinkdiv"--%>
                                                <ul>
                                                    <li class="nav-section-home navSectionSublinks navlist selectedLink" style="margin-left: 1px; padding: 10px; text-decoration: none;">
