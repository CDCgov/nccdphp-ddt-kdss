...
{
    public partial class SideNavAYA : System.Web.UI.UserControl
    {
        ...
        private string MethodsIndicatorsTableCreation(int TopicID, string TopicText)
        {
            ...
            //Start table HTML
            sbTable.Append("<div class=\"navBoldHeader nav-section-home d-sm-block\" aria-multiselectable=\"true\" role=\"tabpanel\" ><span>" + TopicText +"</span></div>");
            ...
            foreach (DataRow dr in dtMeasures.Rows)
            {
                ...
                if (IsSelected(measureID)) {
                    sbTable.Append("<div class=\"card-header nav-section-home navSectionLinks navlist\" id=\"accordion-4-card-" + loopcnt.ToString() + "\" data-target=\"#accordion-4-collapse-" + loopcnt.ToString() + "\" data-toggle=\"collapse\" role=\"tab\" aria-expanded=\"true\">"); //begin header measureText
                    sbTable.Append("<a style=\"display: inline;color:#000000\" tabindex=\"0\"  id=\"accordion-title-" + loopcnt.ToString() + "\" title=\" " + measureText + "\" data-controls=\"accordion-4-collapse-" + loopcnt.ToString() + "\" >" + measureText + "<i class=\"fi cdc-icon-minus nav-minus\"  style = \"float: right;\" id=\"navplusicon\"  ></i></a>");
                    sbTable.Append("</div>");
                    ...
                    sbTable.Append("<a style=\"display: inline;color:#000000\" tabindex=\"0\"  id=\"accordion-title-" + loopcnt.ToString() + "\" title=\" " + measureText + "\" data-controls=\"accordion-4-collapse-" + loopcnt.ToString() + "\" >" + measureText + "<i class=\"fi cdc-icon-plus nav-\"  style = \"float: right;\" id=\"navplusicon\"  ></i></a>");
                    sbTable.Append("</div>");
