<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccordionIndicatorControl.ascx.cs" Inherits="CKDSurveillance_RD.UserControls.AccordionIndicatorControl" %>
