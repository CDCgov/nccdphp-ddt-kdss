<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="accordionindicatorcontrolSpecialFactor.ascx.cs" Inherits="CKDSurveillance_RD.UserControls.accordionindicatorcontrolSpecialFactor" %>
