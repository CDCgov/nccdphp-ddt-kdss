<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatientsRD.ascx.cs" Inherits="CKDSurveillance_RD.UserControls.RDVersions.PatientsRD" %>
...
<div class="nccd-modA CornerMe">
    ...
    <h3 style="font-family: Poppins;">
      ...
      <p>
       <asp:image ID="Image1" ImageUrl="~/images/Hands.png" runat="server"  align="left" AlternateText="Patient Focus - Hands image" style="margin:7px;" />
