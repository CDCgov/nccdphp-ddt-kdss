...
<%
	...
	Function FoundSuspectTags(Byval InputString, Byval chkCSS, Byval chkSQLInj, ByVal chkQueryStr)
		...
		If cbool(chkCSS) Then
			...
			REPattern = REPattern & "|" & "\s*(?:CMCDLLNAME|javascript|vbscript|charset|0x0d|LF|0x0a|%0d|%0a|content-type|content-length)\s*"
		...
		If cbool(chkSQLInj) then
			If REPattern = "" then
				REPattern = "\s*((?:\%25|\%)|(?:\%5C|\\)|(?:\%2F|\/)|(?:\%27|\')|(?:\%2D\%2D|\-\-)|(?:;|\%3B)|xp_|sp_|(?:\%3A|\:)|(?:\%28|\()|(?:\%29|\))|(?:\%26|&)|(?:\%23|\#)|(?:\%24|\$)|(?:\%5E|\^)|(?:\%2A|\*)|(?:\%2B|\+)|(?:\%3D|=))\s*"
			Else
				REPattern = REPattern & "|" & "\s*((?:\%25|\%)|(?:\%5C|\\)|(?:\%2F|\/)|(?:\%27|\')|(?:\%2D\%2D|\-\-)|(?:;|\%3B)|xp_|sp_|(?:\%3A|\:)|(?:\%28|\()|(?:\%29|\))|(?:\%26|&)|(?:\%23|\#)|(?:\%24|\$)|(?:\%5E|\^)|(?:\%2A|\*)|(?:\%2B|\+)|(?:\%3D|=))\s*"
			End if
